    ...
    public static void main(final String... s) {
       ...
       for (int i = 1; i < ELEMS; i++) {
        ...
        System.out.println("Adding " + ELEMS
                + " element in the ArrayList took " + time
                + "ns (" + time / TO_MS + "ms)");
        ...
        System.out.println("Adding " + ELEMS
                + " elements in the LinkedList took " + time2
                + "ns (" + time2 / TO_MS + "ms)");
        ...
        System.out.println("reading " + ELEMS
                + " elements in the ArrayList took " + time3
                + "ns (" + time3 / TO_MS + "ms)");
        ...
        System.out.println("reading " + ELEMS
                + " elements in the linkedList took " + time4
                + "ns (" + time4 / TO_MS + "ms)");
        ...
        long wordPopulation;
        wordPopulation = myMap.get("Africa") + myMap.get("Americas") + 
        		myMap.get("Antarctica") + myMap.get("Asia") + myMap.get("Europe") + myMap.get("Oceania");
