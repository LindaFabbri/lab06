...
public interface SocialNetworkUser<U extends User> extends User {
	 ...
	 * 
	 * @param group the group (circle) on which the user in going to be added
	 * @param user  the user to be added as a user followed
	 * @return true if the user to be added as a followed person does not exist yet,
	 *         false otherwise
	 */
