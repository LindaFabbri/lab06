 ...
 * {@link it.unibo.oop.lab.collections2.User}.
 * 
...
public class UserImpl implements User {
	...
	/**
	 * Builds a new UserImpl. An age not specified means that the age field is going
	 ...
	 * @param user    alias of the user, i.e. the way a user is identified within an
	 *                application
	 */
	...
	public boolean equals(final Object o) {
		...
		if (o != null && getClass().equals(o.getClass())) {
			...
			return firstName.equals(user.getFirstName()) && lastName.equals(user.getLastName())
					&& username.equals(user.getUsername()) && age == user.getAge();
		}
		return false;
	}
